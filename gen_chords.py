...
#--------------------------------------------------------------------------------------------------------------------------------------------
# Function to collect all the songs in the directory
def get_songs(path):
...
lowest_note = midi_manipulation.lowerBound  # the lowest note on the piano roll
highest_note = midi_manipulation.upperBound  # the highest note on the piano roll
...
lr = tf.constant(0.005, tf.float32)  # The learning rate
